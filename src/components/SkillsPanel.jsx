...
const SkillsPanel = ({ icon, title, skills, color, expandRatio = 2.5, transitionDuration = 600, proficiencyLevel = 'Expert' }) => {
  ...
  return (
    <motion.div
      ...
      className="skill-panel relative cursor-pointer group overflow-hidden rounded-xl flex-1 h-full"
      style={{ 
        minHeight: '400px',
        transition: `all ${transitionDuration}ms cubic-bezier(0.25, 0.46, 0.45, 0.94)` // Smoother easing
      }}
    >
